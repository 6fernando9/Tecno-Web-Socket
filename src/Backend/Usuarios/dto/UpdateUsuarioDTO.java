...
public class UpdateUsuarioDTO {
    ...
    public UpdateUsuarioDTO(Long id,String username,String nombre, String password,String correo, Long telefono,String tipo){
        this.id = id;
    ...
    public static UpdateUsuarioDTO crearUpdateUsuarioMedianteSubject(String subject) throws InvalidDataException {
        ...
        String tipoDto = tipo;
        return new UpdateUsuarioDTO(idDto,usernameDto,nombreDto,passwordDto,correoDto,telefonoDto,tipoDto);
    }
